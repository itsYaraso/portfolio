export default function aboutMeSection() {
  ...
  return (
    <section>
      <h2 className="text-5xl mb-4 text-center">About me</h2>
      <hr className="mx-auto pb-4"></hr>

      <p className="text-sm text-center break-normal text-balance z-0 leading-7 max-w-[64ch] tracking-tightest">
        <br></br>
        I am 31, father of 3 based in Finland, originating from Manchester, United Kingdom.
        <br></br>
        <br></br>
